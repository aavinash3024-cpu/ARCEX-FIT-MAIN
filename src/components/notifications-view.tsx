            ...
            <div className="flex gap-2 pt-1">
              <button 
                ...
                className={cn(
                  ...
                  autoDeletePeriod === '24h' ? "bg-primary border-primary text-white shadow-md shadow-primary/20" : "bg-card border-muted/20 text-muted-foreground"
                )}
              >
                24 Hours
              </button>
              <button 
                ...
                className={cn(
                  "flex-1 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all border",
                  autoDeletePeriod === '1w' ? "bg-primary border-primary text-white shadow-md shadow-primary/20" : "bg-card border-muted/20 text-muted-foreground"
                )}
              >
                1 Week
              </button>
